...
public class Contact2 implements Comparable<Contact2> {
	...
	// Default constructor
	public Contact2(String imgPath, String name, String contactId, int position) {
		init(imgPath, name, contactId, position);
	}
	
	// Construct from a string
	public Contact2(String input) {
	...
	public int compareTo(Contact2 other) {
